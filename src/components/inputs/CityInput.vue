<script setup lang="ts">
  ...
  import { PencilIcon, LocationMarkerIcon } from '@heroicons/vue/outline'
  ...
  watch(
    () => props.inputValue,
    (newValue: string) => (state.city = newValue)
  )
  ...
  if (props.required) {
    ...
    rules.value.city = { ...rules.value.city, required }
  }
  ...
  <div>
    ...
    >
      ...
      <span
        ...
        :class="v$.city.$error ? 'text-red-400' : ''"
      >
        <PencilIcon />
      </span>
      <input
